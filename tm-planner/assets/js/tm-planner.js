...
function putGuideSpecialNotMetMsg(teamId, specialsNeeded) {
    team = $(".team[data-team=" + teamId +"]");
    msgStr = "&nbspCounter to Boss actions from Preemp may not be met (assuming max Bind and Despair sockets, and currently not including CA, Super SP, Swap Effect, Sailor, and Support):<br>";
    specialStr = "";
